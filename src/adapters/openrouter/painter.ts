...
const PAINTER_ROLE = `You are an expert digital-signage screen designer creating ONE self-contained screen for a TV that guests read across a room (the exact pixel canvas is given under "Target canvas" below).`;
